...
const { data } = await useFetch(baseAPI + 'piano/?tipologia=PUA');
                ...
                <div class="row ">
                    <div class="col-12 col-lg-10">
                        ...
                        <nav aria-label="breadcrumb" class="breadcrumb-container">
                            ...
                            <li class="breadcrumb-item active">Archivio della Pianificazione Attuativa</li>
                            <!----><!----><!---->
                            </ol>
                        </nav>
                        </div>
                ...
                <div class="cmp-hero">
                    <section class="it-hero-wrapper bg-white align-items-start">
                        <div class="it-hero-text-wrapper pt-0 ps-0 pb-4 pb-lg-60">
                            <h1 data-element="page-name" class="text-black">Archivio della Pianificazione Attuativa</h1>
                            <div class="hero-text">
                            <p>Piani Urbanistici Attuativi</p>
